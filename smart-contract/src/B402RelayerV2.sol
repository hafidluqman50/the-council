...
// Vendored verbatim from https://github.com/Vistara-Labs/b402 (MIT) — our own instance,
// deployed and owned by us, since the shared/hosted relayer only whitelists real USDT
// and we don't control its owner key to whitelist our own MockUSDT.
