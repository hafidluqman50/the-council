...
const KNOWN_TOKENS: Record<string, { decimals: number; symbol: string; name: string }> = {
  ...
  // BSC Testnet
  // decimals corrected to 18: upstream hardcoded 6, but an on-chain decimals() read against
  // this exact testnet contract on 2026-09-23 returned 18. Left at 6 upstream this silently
  // mis-formats amount_formatted in Supabase logs without affecting on-chain transfer math,
  // which always uses the raw atomic authorization.value.
  '0x337610d27c682E347C9cD60BD4b3b107C9d34dDd': { decimals: 18, symbol: 'USDT', name: 'Tether USD (Testnet)' },
};
